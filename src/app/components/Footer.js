      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Lucas Qin</h3>
            <p className="text-gray-300 mb-6 max-w-md">
            Working with others to turn ideas into simple, helpful tech for real people
            </p>
            <div className="flex space-x-4">
              <span className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Lucas Qin. All rights reserved.
          </p>
